...
ANIMALS = [
    ...
    (108, "Axolotl                  ", "Axolotl"),
    (109, "Fire Salamander          ", "Fire salamander"),
    (110, "American Bullfrog        ", "American bullfrog"),
    (111, "Toad                     ", "Common toad"),
    (112, "Newt                     ", "Smooth newt"),
    (113, "Tiger Salamander         ", "Tiger salamander"),
    ...
    (129, "Praying Mantis           ", "European mantis"),
    ...
    (114, "Great White Shark        ", "Great white shark"),
    (115, "Whale Shark              ", "Whale shark"),
    ...
    (102, "Boa Constrictor          ", "Boa constrictor"),
